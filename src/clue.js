...
return `${pickedMystery.suspect.firstName} ${pickedMystery.suspect.lastName} killed Mr. Boddy using the ${pickedMystery.weapon.name} in the ${pickedMystery.room.name}!`
}